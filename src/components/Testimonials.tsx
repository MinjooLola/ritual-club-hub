...
const Testimonials = () => {
  const allTestimonials = [
    ...
    {
      challenge: "기록리추얼챌린지",
      content: "내가 찾던 글쓰기 모임이었어요. 매일 글을 쓰고, 다른 사람들이 읽는다는 전제를 두다 보니 글의 흐름을 어떻게 잡을지 고민하게 되었고, 업로드 전에 최소 한두 번은 다시 읽고 고치는 습관이 생겼습니다. 단순히 '글을 쓴다'는 행위가 아니라, '읽히는 글을 쓴다'는 태도로 변화한 것이 가장 큰 성과예요.",
      author: "헤븐리",
    ...
    {
      challenge: "모닝리추얼챌린지",
      content: "롤라의 리추얼클럽 덕분에, 큰 노력이나 압박감 없이도 하루 딱 30분만 투자했을 뿐인데 올해 세웠던 다짐들을 하나씩 이뤄가고 있더라고요! 진짜 롤라의 리추얼은 활용하기에 따라 각 리추얼의 목적 이상으로 두 배, 세 배의 효과를 얻을 수 있는 프로그램이에요.",
      author: "감짱",
    ...
    {
      challenge: "나이트리추얼챌린지",
      content: "책읽고 싶은 마음만 있는 사람에서 책을 읽고있는 사람으로 바뀌었다. 취침전 30분 간의 독서 루틴을 수행하는 시간이 소중한 변화의 계기를 마련해줬습니다. 실시간 참여 프로그램의 강제성과 함께하는 챌린저들의 힘이 정말 대단해요.",
      author: "난다",
      link: "https://blog.naver.com/nan_da/224062111160"
    },
    {
      challenge: "모닝리추얼챌린지",
