...
const ChallengeDetail = () => {
  ...
  const challengeDetails = {
    ...
    reading: {
      title: "독서리추얼챌린지",
      subtitle: "인생을 바꾸는 독서 & 기록 습관 만들기",
      icon: <Moon className="w-8 h-8 text-indigo-600" />,
      color: "from-indigo-50 to-purple-50",
      time: "주 5회 최소 30분 이상 책 읽기",
      type: "독서 인증 챌린지",
      description: "각자 원하는 시간에 하루 최소 30분 이상 책을 읽고 인증합니다. 매일 독서 시간을 확보하며 꾸준한 독서 습관을 만들어갑니다.",
      benefits: [
        "꾸준한 독서 습관 형성",
        "독서를 통한 자기계발",
        "다양한 책 정보 공유",
    ...
    spanish: {
      title: "스페인어리추얼챌린지",
      subtitle: "각자 원하는 스페인어 공부 방식으로 실력 향상",
      icon: <Users className="w-8 h-8 text-pink-600" />,
      color: "from-pink-50 to-rose-50",
      time: "주 5회 최소 30분 이상 스페인어 공부",
      type: "스페인어 공부 인증 챌린지",
      description: "각자 원하는 스페인어 공부 방식으로 매일 스페인어를 공부하고 인증하는 챌린지입니다. 개인의 학습 스타일과 시간에 맞춰 자유롭게 참여할 수 있으며, 초보자를 위해 스페인어 전공자 리더가 가이드를 제공합니다.",
      benefits: [
        "개인 맞춤형 스페인어 학습",
        "꾸준한 스페인어 학습 습관 형성",
        "스페인어 전공자의 전문적인 가이드",
